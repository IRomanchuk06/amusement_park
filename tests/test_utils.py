...
class TestUserInputFunctions(unittest.TestCase):
    ...
    def test_get_menu_choice_valid(self, mock_input):
        ...
        result = AmusementParkUtils.get_menu_choice("Choose a number between 1 and 4: ", valid_choices)
    ...
    def test_get_valid_input_float(self, mock_input):
        result = AmusementParkUtils.get_valid_input("Enter a valid float: ", float)
    ...
    def test_get_valid_input_int(self, mock_input):
        result = AmusementParkUtils.get_valid_input("Enter a valid integer: ", int)
    ...
    def test_display_header(self, mock_stdout):
        AmusementParkUtils.display_header("Test Title")
